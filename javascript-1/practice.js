...
// 	age: 22,
// 	greeter: [
// 		`Hello! My name is ${name} and I live in ${state}`
// 	]
// }
//////////////////PROBLEM 12////////////////////
...
// Code Here
var doubled = myNumbers.map((element) => {
	return element * 2
});
//////////////////PROBLEM 15////////////////////
...
const filtered = myNumbers.filter(myNumbers => myNumbers > 100);
//////////////////PROBLEM 16////////////////////
...
// Code Here
var forTheLoveOfGeorge = notGeorge.map((element) => {
...
// Code Here
var totallyAwesome = people.reduce((acc, cur) =>{
